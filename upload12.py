...
projectId = '188ba309e72a423bb1bf8ee8987d8554'
region = 'dallas'
userId = '8196531bc04d47de8efa37208362e26d'
password = 'Ww(sKtZI=f6o7U*w'
container_name = 'PramodContainer'
conn = swiftclient.Connection(key=password,
                              ...
                              os_options={"project_id": projectId,
                                          ...
                                          "region_name": region})
dpath = ''
folder = 'C:\Users\pramo\Downloads\IBMBlueMixProject7'
...
def upload(filename):
    ...
    if size <= '10000':
        ...
        conn.put_object('PramodContainer', f1.filename, contents, content_type='text/plain')
    else:
